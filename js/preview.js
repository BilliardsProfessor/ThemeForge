...
function openPreviewDialog() {
    const dialogLayer = document.querySelector("#previewDialogLayer");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector("#openPreviewDialogBtn")?.addEventListener("click", openPreviewDialog);

    document.querySelectorAll("[data-close-preview-dialog]").forEach((button) => {
        button.addEventListener("click", () => {
            document.querySelector("#previewDialog")?.close();
            document.querySelector("#previewDialogLayer").hidden = true;
        });
    });
